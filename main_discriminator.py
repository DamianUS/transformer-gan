...
import pickle
from data_load_discriminator import get_ori_data, scale_data
...
def main(args):
    ...
    channels = [16, 32, 64]
    model = DiscriminatorTransformer(n_features=n_features, hidden_dim=hidden_dim, seq_len=args.seq_len,
                        narrow_attn_heads=narrow_attn_heads, num_layers=num_layers, dropout=dropout)
