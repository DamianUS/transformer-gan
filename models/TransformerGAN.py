...
class TransformerGAN(torch.nn.Module):
    def __init__(self, num_features, seq_len, batch_size, num_layers, hidden_dim, narrow_attn_heads, dropout=0, noise_length=100):
        ...
        self.generator = GeneratorTransformer(n_features=num_features, hidden_dim=hidden_dim*4, seq_len=seq_len, narrow_attn_heads=narrow_attn_heads*2, num_layers=num_layers+1, dropout=dropout, noise_length=noise_length)
