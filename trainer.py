...
class StepByStep(object):
    ...
    def _make_train_step_fn(self):
        ...
        def perform_train_step_fn(x, y):
            ...
            if loss_discriminator_real > 0.15 and loss_discriminator_fake > 0.15:
    ...
    def train(self, n_epochs, seed=42, n_clip=5):
        ...
        self.set_seed(seed)
        # self.scheduler = torch.optim.lr_scheduler.LinearLR(self.discriminator_optimizer, start_factor=0.05, total_iters=n_epochs*len(self.train_loader))
        self.n_clip = n_clip
